...
//------------------------------------------------------------------------------------------------------------------------------
  ...
  void                  residual(level_type * level, int res_id, int x_id, int rhs_id, REAL a, REAL b);
...
//------------------------------------------------------------------------------------------------------------------------------
  ...
  void      interpolation_vcycle(level_type * level_f, int id_f, REAL prescale_f, level_type *level_c, int id_c); // interpolation used inside a v-cycle
  void      interpolation_fcycle(level_type * level_f, int id_f, REAL prescale_f, level_type *level_c, int id_c); // interpolation used in the f-cycle to create a new initial guess for the next finner v-cycle
//------------------------------------------------------------------------------------------------------------------------------
...
REAL                      norm(level_type * level, int id_a);
