...
#include <math.h>
//------------------------------------------------------------------------------------------------------------------------------
static inline void interpolation_p2_block(level_type *level_f, int id_f, REAL prescale_f, level_type *level_c, int id_c, blockCopy_type *block){
  ...
  int i,j,k;
  REAL OneOver32Cubed = 1.0/32768.0;
...
void interpolation_p2(level_type * level_f, int id_f, REAL prescale_f, level_type *level_c, int id_c){
